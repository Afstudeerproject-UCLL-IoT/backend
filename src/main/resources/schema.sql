...
ALTER TABLE connection_activity
...
ALTER TABLE puzzle
    ADD FOREIGN KEY ("device_owner_id") REFERENCES device ("id");

ALTER TABLE puzzle_attempt
    ADD FOREIGN KEY ("puzzle_name") REFERENCES puzzle ("name");

ALTER TABLE puzzle_attempt
    ADD FOREIGN KEY ("game_session_id") REFERENCES game_session ("id");

ALTER TABLE puzzle_subscriber
    ADD FOREIGN KEY ("subscriber_device_id") REFERENCES device ("id");

ALTER TABLE puzzle_subscriber
    ADD FOREIGN KEY ("subscribed_to_puzzle_name") REFERENCES puzzle ("name");
